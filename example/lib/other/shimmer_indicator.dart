...
class ShimmerHeader extends RefreshIndicator {
  ...
  final Widget Function(Widget child)? outerBuilder;
...
class _ShimmerHeaderState extends RefreshIndicatorState<ShimmerHeader>
  ...
  Widget buildContent(BuildContext context, RefreshStatus mode) {
    ...
    return widget.outerBuilder?.call(body) ?? body;
  }
}
...
class _ShimmerFooterState extends LoadIndicatorState<ShimmerFooter> {
  ...
  Widget buildContent(BuildContext context, LoadStatus mode) {
    ...
    final Widget content = body ?? const SizedBox.shrink();
    return widget.outerBuilder?.call(content) ?? content;
  }
}
